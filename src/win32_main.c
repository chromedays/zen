...
SCENE_INIT_FN_SIG(unlit_scene_init)
{
    ...
    vb_init(&scene->sp_vb, &scene->sp_mesh, GL_TRIANGLES);
...
SCENE_INIT_FN_SIG(raytracer_scene_init)
{
    ...
    vb_init(&scene->fsq_vb, &scene->fsq_mesh, GL_TRIANGLES);
